...
const char DESCRIPTION[MANY_TESTS+1][256] = {
		...
		"Testing insert/append when current DEFAULT_CAPACITY exceeded"
};
...
int test4( )
{
	...
	cout << "append that many items. The sequence should NOT need to\n";
...
int test6( )
{
	...
	original.insert(2);
	original = original; //Compiler warning here can be ignored
	if (!correct
